...
const Visualization = () => {
    return (
        <React.Fragment>
            <Row>
                <Col md={6} xl={8}><h4 className="mb-4">Visualization</h4></Col>
                <Col md={6} xl={4}>
                    <Button variant="primary" className="text-capitalize" style={{ float: 'right' }}>
                        <Link to={"/app/visualization/create"}> Create</Link>
                    </Button>
                </Col>
            </Row>
            <Row>
